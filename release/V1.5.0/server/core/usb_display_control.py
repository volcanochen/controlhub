...
def set_brightness(brightness):
    """Set monitor brightness using unified brightness module
    ...
    try:
        ...
        from brightness import set_brightness as _set_brightness
        return _set_brightness(brightness)
    except ImportError as e:
        print(f"Error importing brightness module: {e}")
        return False, f"Brightness module error: {e}"

...
import com.volcano.controlhub.ui.SettingsActivity;
import com.volcano.controlhub.ui.LogActivity;
import com.volcano.controlhub.imagecast.ImageDisplayActivity;
import com.volcano.controlhub.display.DisplayController;
import com.volcano.controlhub.display.DisplayManager;
import com.volcano.controlhub.imagecast.ImageCastingController;
import com.volcano.controlhub.display.BrightnessController;
import com.volcano.controlhub.miio.MiioDevice;
import android.view.WindowManager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraButton.setOnClickListener(v -> {
            Intent intent = new Intent(MainActivity.this, com.volcano.controlhub.camera.CameraActivity.class);
            startActivity(intent);
        });
        ...
        imageCastingController = new ImageCastingController(this);
        
        com.volcano.controlhub.camera.CameraService.getInstance().initialize(this);
    ...
    private void checkFeatureSettings() {
        ...
        if (brightnessContainer != null) {
            boolean sensorAvailable = brightnessController.isSensorAvailable();
            Log.d(TAG, "Brightness check: enabled=" + brightnessEnabled + ", sensorAvailable=" + sensorAvailable);
            if (brightnessEnabled && sensorAvailable) {
                ...
                Log.d(TAG, "Brightness controller started");
            } else {
                brightnessContainer.setVisibility(View.GONE);
            }
        }

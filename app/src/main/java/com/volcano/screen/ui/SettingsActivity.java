...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void testConnection() {
        ConnectionTester.test(this, displayManager, executorService);
    }
    ...
    private void startNetworkSpeedTest() {
        ...
        resultText.setText("正在初始化双通道测试...\n\n将依次测试 USB 和 WiFi 速度\n请稍候...");
        dialog.show();
        
        String usbUrl = "http://localhost:8765";
        String wifiUrl = "http://" + displayManager.getWifiAddress() + ":" + displayManager.getWifiPort();
        
        speedTester = new NetworkSpeedTester(resultText, usbUrl);
